...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'deepSeekApi': 'DeepSeek API (recommended)',
      'sugoiLocal': 'Local Sugoi (Japanese to English)',
      'deepSeekApiKey': 'DeepSeek API key',
      'deepSeekApiKeyHint':
          'Stored only in the local JHenTai configuration and never committed to Git',
      'deepSeekModel': 'DeepSeek model (thinking disabled)',
