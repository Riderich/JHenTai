...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'openAICompatibleApi': 'Custom API (OpenAI compatible)',
      ...
      'retranslateCurrentPage': 'Retranslate current page',
      'translatingCurrentPage': 'Translating current page…',
      'translatePageRange': 'Translate page range…',
      ...
      'translationCompleted': 'Page translation completed',
      'translationFailed': 'Page translation failed',
