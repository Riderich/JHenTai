...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'translationServiceHint': 'JHenTai sends the current page to a local translation service. The service performs text detection, OCR, translation, inpainting, and typesetting, then returns a translated image.',
      ...
      'translationServiceUnavailable': 'Translation service is unavailable. Start it and check the URL.',
