...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      'translationRuntimePreparing': '正在准备初始化…',
      'translationRuntimeReady': '翻译服务已就绪',
      'translationRuntimeStopped': '环境已安装，服务尚未启动',
      'translationRuntimeNotInitialized': '尚未初始化。点击按钮后将自动准备所有依赖。',
      ...
      'openAICompatibleApi': '自定义 API（OpenAI 兼容）',
      ...
      'translationApiModelHint': '由服务商决定，例如 deepseek-v4-flash、qwen3:8b',
      'disableThinking': '请求关闭思考模式',
      'disableThinkingHint': '向兼容服务发送 thinking=disabled；不支持该参数时请关闭',
      'localTranslationModelHint': '本地模型无需 API Key，首次使用会下载额外模型；CUDA 可显著提升处理速度。',
      'sourceLanguage': '源语言',
      'targetLanguage': '目标语言',
      ...
      'retranslateCurrentPage': '重新翻译当前页',
      'translatingCurrentPage': '正在翻译当前页…',
      'translatePageRange': '翻译页面范围…',
      'rangeStartPage': '起始页',
      'rangeEndPage': '结束页',
      'translationPageRangeHint': '请输入 1 到 @count',
      ...
      'translationImageNotReady': '当前图片尚未加载完成',
      'translationCompleted': '本页翻译完成',
      'translationFailed': '本页翻译失败',
